...
import { TableProps, TableHeaderProps, TableBodyProps, TableRowProps, TableHeaderCellProps, TableCellProps, TableCaptionProps, TableContainerProps, TableEmptyStateProps, TableLoadingStateProps, TableContextValue } from "./types";
export declare const useTable: () => TableContextValue<any>;
declare const Table: {
